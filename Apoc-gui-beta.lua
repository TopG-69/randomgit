...
BigText.Text = "Script Info [04/16/2023] [14/38/UTC+2] [DeaTh-X-AngEl] ━━━━━━━━━━━━━━━━━━━━━━"
...
SmallText.BorderSizePixel = 0
SmallText.Text = "(/) Script version: 142"
...
CreateUpdateLogMessage("(+) Improved UI!", 60, 160, 60)
CreateUpdateLogMessage("(+) Improved Bases tab!", 60, 160, 60)
CreateUpdateLogMessage("(+) Bases can be spawned on other people now!", 60, 160, 60)
CreateUpdateLogMessage("(+) Bases won't lag your game anymore!", 60, 160, 60)
...
Tools4Page2FeaturesSpawning.MouseButton1Down:connect(function()
	if BasesTabSelectedPlayer ~= nil and BasesTabSelectedPlayer ~= "nan" and BasesTabSelectedPlayer ~= "" then
		local SPlayer = game.Players:FindFirstChild(BasesTabSelectedPlayer)
		if BasesTabSelectedBase ~= nil and BasesTabSelectedBase ~= "nan" and BasesTabSelectedBase ~= "" then
			if BasesTabSelectedBase == "Castle" then
				...
				local OSstart = os.time()
				AntiBreakCastleBaseA, result = pcall(function()
					SpawnBase(CastleBaseA, SPlayer.Character.Head.Position-Vector3.new(0, 4, 0))
				end)
				wait()
				AntiBreakCastleBaseB, result = pcall(function()
					SpawnBase(CastleBaseB, SPlayer.Character.Head.Position-Vector3.new(0, 4, 0))
				end)
				wait()
				AntiBreakCastleBaseC, result = pcall(function()
					SpawnBase(CastleBaseC, SPlayer.Character.Head.Position-Vector3.new(0, 4, 0))
				end)
				wait()
				AntiBreakCastleBaseD, result = pcall(function()
					SpawnBase(CastleBaseD, SPlayer.Character.Head.Position-Vector3.new(0, 4, 0))
				end)
				wait()
				AntiBreakCastleBaseE, result = pcall(function()
					SpawnBase(CastleBaseE, SPlayer.Character.Head.Position-Vector3.new(0, 4, 0))
				end)
				local OSend = os.time()
				local FinalOStime = (OSend-OSstart)
				AnnounceBox("Castle base loaded in "..tostring(FinalOStime).."s!", "BASES", 5, 255, 255, 255, 255, 255, 255)
			end
			AnnounceBox("No player selected!", "ERROR", 5, 95, 60, 60, 255, 255, 255)
		end
	else
