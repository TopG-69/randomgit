...
--UpdatesPhrame.BackgroundTransparency = 0.4
--UpdatesPhrame.ScrollBarImageColor3 = Color3.fromRGB(0, 0, 0)
--UpdatesPhrame.ScrollBarThickness = 4
...
UpdateLabelScript.Text = "Version: "--..versionCURRENT
