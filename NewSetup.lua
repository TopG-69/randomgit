...
UpdateLabel.Size = UDim2.new(0, 0, 0, 0)
UpdateLabel.Position = UDim2.new(0.5, 0, 0.10, 0)
UpdateLabel.BorderSizePixel = 0
UpdateLabel.Text = "Version: "..versionCURRENT
UpdateLabel.Transparency = 0.9
UpdateLabel.TextColor3 = Color3.fromRGB(0,255,255)
UpdateLabel.TextSize = 12
UpdateLabel.TextXAlignment = "Center"
UpdateLabel.Parent = UpdatesPhrame

local UpdateLabel = Instance.new("TextLabel")
UpdateLabel.Size = UDim2.new(0, 0, 0, 0)
UpdateLabel.Position = UDim2.new(0.5, 0, 0.40, 0)
UpdateLabel.BorderSizePixel = 0
UpdateLabel.Text = "loading might take some time!"
UpdateLabel.TextColor3 = Color3.fromRGB(140,140,140)
...
local UpdateLabel = Instance.new("TextLabel")
UpdateLabel.Size = UDim2.new(0, 0, 0, 0)
UpdateLabel.Position = UDim2.new(0.5, 0, 0.65, 0)
UpdateLabel.BorderSizePixel = 0
UpdateLabel.Text = "is new loader better?"
UpdateLabel.TextColor3 = Color3.fromRGB(140,140,140)
UpdateLabel.TextSize = 9
UpdateLabel.TextXAlignment = "Center"
UpdateLabel.Parent = UpdatesPhrame
...
UpdateLabelScript.Position = UDim2.new(0.5, 0, 0.9, 0)
UpdateLabelScript.BorderSizePixel = 0
UpdateLabelScript.Text = "idk welcome ig"
