...
--[--Script
if game.PlaceId == 2866967438 and OUTDATEDVERSION == false and Discord_Key == "123" and FixedThemes and FSISPATCHED == false then
...
elseif game.PlaceId == 69184822 and OUTDATEDVERSION == false and Discord_Key == "123" and FixedThemes and TPT2ISPATCHED == false then
...
elseif game.PlaceId == 54865335 and OUTDATEDVERSION == false and Discord_Key == "123" and FixedThemes and UDISPATCHED == false then
...
elseif BrokenThemes and OUTDATEDVERSION == false and Discord_Key == "123" and IsPatched then
...
elseif Discord_Key ~= "123" and FixedThemes and IsPatched then
...
elseif OUTDATEDVERSION == true and Discord_Key == "123" and FixedThemes and IsPatched then
...
elseif game.PlaceId ~= 2866967438 or game.PlaceId == 69184822 or game.PlaceId == 54865335 and OUTDATEDVERSION == false and Discord_Key == "123" and FixedThemes and IsPatched then
...
elseif OUTDATEDVERSION == false and Discord_Key == "123" and FixedThemes and TPT2ISPATCHED == true or UDISPATCHED == true or FSISPATCHED == true then
